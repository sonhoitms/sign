...

{
    ...
    "assets": {
        "web.assets_backend": [
            ...
            "sign_oca/static/src/components/sign_oca_pdf/**/*.js",
            "sign_oca/static/src/components/sign_oca_pdf/**/*.xml",
            "sign_oca/static/src/components/sign_oca_pdf_common/**/*.js",
            "sign_oca/static/src/components/sign_oca_pdf_common/**/*.xml",
            "sign_oca/static/src/components/sign_oca_pdf_portal/**/*.js",
            "sign_oca/static/src/components/sign_oca_pdf_portal/**/*.xml",
            "sign_oca/static/src/components/sign_oca_configure/**/*.xml",
            "sign_oca/static/src/components/sign_oca_configure/**/*.js",
            "sign_oca/static/src/elements/**/*.js",
            "sign_oca/static/src/elements/**/*.xml",
            "sign_oca/static/src/xml/*.xml",
            "sign_oca/static/src/js/dialog.js",
            "sign_oca/static/src/js/sign_oca.esm.js",
            "sign_oca/static/src/js/signer_menu_view.esm.js",
            "sign_oca/static/src/js/signer_menu_container.esm.js",
        ],
        "web.assets_frontend": [
